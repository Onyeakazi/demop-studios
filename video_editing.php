    ...
    <section id="service-details" class="service-details section">
      <div class="container">
        <div class="row gy-1">
            ...
            <?php 
                $query = "SELECT * FROM services WHERE type = 'video' ";
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
                <div class="service-box">
                        <video width='300' height='189' controls>
                          <source src='./dashboard/assets/img/<?php echo $media ?>' type='video/mp4'>
                          Your browser does not support the video tag.
                        </video>
                    <h2><?php echo $media_name ?></h2>
